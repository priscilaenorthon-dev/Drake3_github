...
<div class="page-header">
    <h1 class="h2 mb-0">
        <i class="bi bi-people text-primary"></i> Editar Equipe
    </h1>
        ...
        <form action="{{ route('teams.update', $team) }}" method="POST">
            ...
            <div class="row">
                <div class="col-md-6 mb-3">
                    ...
                    <select name="unit_id" id="unit_id" class="form-select @error('unit_id') is-invalid @enderror" required>
                        ...
                        @foreach($units as $unit)
                            <option value="{{ $unit->id }}" {{ old('unit_id', $team->unit_id) == $unit->id ? 'selected' : '' }}>
                                {{ $unit->name }}
                            </option>
                        @endforeach
                    </select>
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <input type="text" name="code" id="code" class="form-control @error('code') is-invalid @enderror" value="{{ old('code', $team->code) }}">
                    @error('code')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
            ...
            <div class="mb-3">
                <div class="form-check">
                    ...
                    <input type="checkbox" name="active" id="active" class="form-check-input" value="1" {{ old('active', $team->active) ? 'checked' : '' }}>
