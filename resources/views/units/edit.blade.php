...
<div class="page-header">
    <h1 class="h2 mb-0">
        <i class="bi bi-geo-alt-fill text-primary"></i> Editar Unidade
    </h1>
        ...
        <form action="{{ route('units.update', $unit) }}" method="POST">
            ...
            <div class="row">
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <input type="text" name="code" id="code" class="form-control @error('code') is-invalid @enderror" value="{{ old('code', $unit->code) }}">
                    @error('code')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
            ...
            <div class="mb-3">
                <div class="form-check">
                    ...
                    <input type="checkbox" name="active" id="active" class="form-check-input" value="1" {{ old('active', $unit->active) ? 'checked' : '' }}>
