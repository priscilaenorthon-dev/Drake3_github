...
<div class="page-header">
    <h1 class="h2 mb-0">
        <i class="bi bi-briefcase-fill text-primary"></i> Novo Cargo
    </h1>
    <p class="text-muted small mb-0">Cadastrar novo cargo</p>
</div>
    ...
    <div class="card-body">
        <form action="{{ route('positions.store') }}" method="POST">
            ...
            <div class="mb-3">
                ...
                <input type="text" name="level" id="level" class="form-control @error('level') is-invalid @enderror" value="{{ old('level') }}" placeholder="Ex: Júnior, Pleno, Sênior">
                @error('level')
                    <div class="invalid-feedback">{{ $message }}</div>
                @enderror
            </div>
